...
<div class="bash-example">
    ...
    --form "name=Sofa"\
    --form "image=@/tmp/phpsd58m4mkk2507r9q5gC" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Ảnh danh mục. Example: <code>/tmp/phpsd58m4mkk2507r9q5gC</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    "http://localhost/admin/categories/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "name=Updated Sofa"\
    --form "image=@/tmp/php0ijs6h3m2bvq9phftvZ" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Ảnh danh mục. Example: <code>/tmp/php0ijs6h3m2bvq9phftvZ</code></p>
        </div>
        </form>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the category category. Example: <code>16</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>category</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
