...
return [
    ...
    'auth' => [
        ...
        'use_value' => env('SCRIBE_AUTH_KEY', 'YOUR_TOKEN'),
    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                ...
                config: [
                    'app.debug' => false,
                    // Skip response calls for specific web routes that return views/redirects
                    'skip' => [
                        'admin/categories',
                        'admin/categories/*',
                    ]
    ...
    // Add an actingAs closure at the root level of your config array
    'actingAs' => function () {
